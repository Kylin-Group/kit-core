    ...
    public static partial class Utility
    {
        ...
        public static class IO
        {
            ...
            public static void BinaryReader(string path, Action<BinaryReader> readerCallback, Encoding encoding = null)
            {
                if (!File.Exists(path))
                {
                    Log.E("binary reader  fail ,error message  'There is no path'. ");
                }
                ...
                {
                    Log.E("binary reader fail exeption path '{0}',error message '{1}'", path, exception.Message);
                }
            }
            ...
            public static byte[] BinaryReaderBytes(string path, Encoding encoding = null)
            {
                ...
                {
                    Log.E("binary reader fail exeption path '{0}',error message '{1}' , error StackTrace '{2}'.", path, exception.Message, exception.StackTrace);
                    return null;
                }
            }
            ...
            public static bool BinaryWriter(string path, Action<BinaryWriter> writerCallback, Encoding encoding = null)
            {
                ...
                catch (Exception exception)
                {
                    ...
                    Log.W("binary writer  fail exeption path '{0}',error message '{1}'", path, exception.Message);
                    return false;
                }
            }
            ...
            public static bool BinaryWriterBytes(string path, byte[] bytes, Encoding encoding = null)
            {
                ...
                {
                    Log.E("binary writer  fail exeption path '{0}', bytes '{1}' , bytes count '{2}'.", path, bytes, bytes != null ? bytes.Length : 0);
                }
            ...
            public static string FileReadText(string path, Encoding encoding = null)
            {
                ...
                {
                    Log.E("FileReadText error , path : '{0}' ,  message: '{1}'  , StackTrace: '{2}'.", path, e.Message, e.StackTrace);
                    return string.Empty;
                }
            }
            ...
            public static bool FileWriteText(string path, string text, Encoding encoding = null)
            {
                ...
                catch (Exception e)
                {
                    ...
                    Log.W("FileWriteText error , path : '{0}' ,  message: '{1}'  , StackTrace: '{2}'.", path, e.Message, e.StackTrace);
                    return false;
                }
            ...
            public static void DeleteFolder(string folderPath, string[] ignore = null)
            {
                ...
                {
                    Log.E("DeleteFolder error , directoryName : '{0}' ,  message: '{1}'  , StackTrace: '{2}'.", folderPath, e.Message, e.StackTrace);
                }
            }
            ...
            public static void CopyFolder(string sourceDirectoryName, string targetDirectoryName, bool isForce = true)
            {
                ...
                {
                    Log.E("CopyFolder error , sourceDirectoryName : '{0}' , targetDirectoryName : '{1}' , message: '{2}'  , StackTrace: '{3}'.",
